...
import static com.example.dell.jingdong.R.id.recyclerView;

/**
 * Created by DELL on 2017/10/10.
 */

public class FenleiFragment2 extends Fragment implements FenleiView{
    private View view;
    ...
    public void getFenlei(final List<Fenlei.DataBean> data) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                FenleiAdapter fenleiAdapter=new FenleiAdapter(getActivity(),fenleilist2);
